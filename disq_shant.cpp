...
void  Disq_Shant::print ( unsigned int i_intent ) {
...
void Disq_Shant::set_disqualified( std::size_t i_placement ) {
    this->disqualified = get_contestant( i_placement );
}

std::string Disq_Shant::get_disqualified() { return this->disqualified; }